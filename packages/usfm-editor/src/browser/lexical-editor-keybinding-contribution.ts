  ...
  implements KeybindingContribution
{
  ...
  registerCommands(registry: CommandRegistry): void {
    ...
    registry.registerCommand(LEXICAL_COPY_COMMAND, {
      execute: () => {
        console.log("Intercepted shortcut: Cut (Ctrl+C)");
        /* No-op, let the event pass through */
      },
    });
    ...
    registry.registerCommand(LEXICAL_PASTE_COMMAND, {
      execute: () => {
        console.log("Intercepted shortcut: Cut (Ctrl+V)");
        /* No-op, let the event pass through */
      },
    });
    ...
    registry.registerCommand(LEXICAL_UNDO_COMMAND, {
      execute: () => {
        console.log("Intercepted shortcut: Cut (Ctrl+Z)");
        /* No-op, let the event pass through */
      },
    });
    ...
    registry.registerCommand(LEXICAL_REDO_COMMAND, {
      execute: () => {
        console.log("Intercepted shortcut: Cut (Ctrl+Shift+Z)");
        /* No-op, let the event pass through */
      },
    });
  }
