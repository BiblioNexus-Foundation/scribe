...
import TranslationNotesView, { TnTSV } from "@/components/TranslationNotes/TranslationNotesView";
...
import type { VerseRefUtils, VerseRefValue } from "@scribe/theia-utils/lib/browser";
...
export const tnResource: ScribeResource<Door43RepoResponse, TnTSV> = {
  ...
  openHandlers: {
    ...
    render(data, ctx) {
      ...
      return <TranslationNotesWrapper verseRefUtils={ctx.verseRefUtils} data={data} />;
    },
  },
};

const TranslationNotesWrapper = (props: { verseRefUtils: VerseRefUtils; data: TnTSV }) => {
  ...
  return (
    <div>
      <div className="text-3xl text-white">{JSON.stringify(ref)}</div>
