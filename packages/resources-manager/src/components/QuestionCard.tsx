...
export default function QuestionCard({
  ...
  return (
    <>
      {isAudio ? (
        <div className="relative space-y-3 rounded-3xl bg-[var(--theia-secondaryButton-foreground)] px-5 py-3 font-normal">
          ...
          <p className="text-[10px] leading-[14px] tracking-wide text-zinc-400 dark:text-zinc-50">
        ...
        <div className="relative space-y-3 rounded-3xl bg-[var(--theia-secondaryButton-foreground)] px-5 py-3 font-normal">
          ...
          <div className="w-full space-y-1 text-[10px] font-normal text-zinc-400 dark:text-zinc-500">
            ...
            <p className="text-[10px] font-normal leading-[14px] tracking-wide text-zinc-700 dark:text-zinc-50">
              Example of picture
            </p>
          </div>
        </div>
