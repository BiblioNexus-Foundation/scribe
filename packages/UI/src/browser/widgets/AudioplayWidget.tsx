...
export class AudioPlayWidget extends ReactWidget {
  ...
  // Inject the VerseRefUtils service
      ...
      <div className="">
        <div className="border-[rgb(250 250 250 / 0.1)] h-[30%] border-t">
          ...
          <div className="flex items-center justify-center p-5">
            {/* <PrevVerse />
            <NextVerse /> */}
            <PrevVerse verseRefUtils={this.verseRefUtils} />
            <NextVerse verseRefUtils={this.verseRefUtils} />
          </div>
             {/* Add BibleNavigation component here */}
