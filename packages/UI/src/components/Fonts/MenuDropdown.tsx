  ...
  return (
    <div>
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        ...
        <DialogContent className="mt-3 bg-gray-800 border-none z-50 flex items-center justify-center">
          <Popover open={open} onOpenChange={setOpen}>
            <PopoverTrigger asChild>
              <button
                role="combobox"
                aria-expanded={open}
                className="w-[300px] justify-between flex items-center px-4 py-2 bg-gray-900 rounded-md text-neutral-400"
              >
                {value
