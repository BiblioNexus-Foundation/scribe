...
const ResizableHandle = ({
  ...
  <ResizablePrimitive.PanelResizeHandle
    ...
    {...props}>
    {withHandle && (
      <div className="z-10 flex items-center justify-center rounded-lg border border-zinc-300 bg-zinc-50 px-1 py-[6px] text-zinc-700 dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-50">
