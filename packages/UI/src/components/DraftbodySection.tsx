    ...
    <div className="">
      <div className="flex items-center border-b py-2.5 px-2 dark:border-zinc-900 border-zinc-200 justify-between ">
        <div className="flex gap-2">
          <Button
            label="1 Cornthians 3:1"
            className="flex-row-reverse gap-3  text-[10px] flex item-center justify-content-center dark:text-gray-300 text-gray-600"
            icon={<IconReload size={14} stroke={2} strokeLinejoin="miter" />}
          />
          ...
          {/* <CustomSelect
            options={sources}
            placeholder="New Revise Standard (NRS)"
            triggerClassName="w-fit h-8  capitalize gap-1   text-[10px] border dark:border-gray-500 border-gray-600 dark:text-gray-300 text-gray-600 rounded-md  "
          /> */}
        </div>
      ...
      <div className="flex w-full  max-h-[80vh]">
        <div className="w-1/4 border-r dark:border-zinc-900 border-zinc-200">
          <div className="flex justify-between items-center py-2">
            ...
            <div className="flex items-center ">
              ...
              <Button
                ...
                icon={<IconClock size={20} stroke={2} strokeLinejoin="miter" />}
              />
              <Button
                className=" dark:bg-transparent rounded-none border-none dark:hover:bg-gray-900"
                icon={
                  <IconBookmark size={20} stroke={2} strokeLinejoin="miter" />
                }
              />
            </div>
          </div>

          <div className="flex-1 border-r dark:border-zinc-900 border-zinc-200 px-2">
              ...
              <ul className="space-y-0">
                {books.map((book) => (
                  <>
                    <li
                      key={book.name}
                      className={`cursor-pointer p-2 rounded-md flex items-center space-x-2 text-[12px] 
                ${
        ...
        <div className="flex-1 flex-col  hide-scrollbar px-2">
          <div
            className={`overflow-auto ${
              activeBook && activeNumber ? "h-[70vh]" : "h-[75vh]"
            } hide-scrollbar px-2`}
          >
          ...
          <div className=" ">
            {activeBook && activeNumber && (
              <div className="flex justify-between mt-1 mb-2 pt-2 border-t  dark:border-zinc-900 border-zinc-200 items-center">
                <Button
                  label="Previous"
